...
export const help: Record<string, string> = {
  ...
  workspaceStrategy: "How BossFlow should realize an execution workspace for this agent. Keep project_primary for normal cwd execution, or use git_worktree for issue-scoped isolated checkouts.",
  ...
  bootstrapPrompt: "Only sent when BossFlow starts a fresh session. Use this for stable setup guidance that should not be repeated on every heartbeat.",
  payloadTemplateJson: "Optional JSON merged into remote adapter request payloads before BossFlow adds its standard wake and workspace fields.",
  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("manualPathDialog.title")}</DialogTitle>
            <DialogDescription>
              {t("manualPathDialog.description")}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 text-sm">
            <section className="space-y-1.5">
              <p className="font-medium">{t("manualPathDialog.macTitle")}</p>
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
                <li>{t("manualPathDialog.mac.step1")}</li>
                <li>{t("manualPathDialog.mac.step2")}</li>
                <li>{t("manualPathDialog.mac.step3")}</li>
                <li>{t("manualPathDialog.mac.step4")}</li>
              </ol>
              <p className="rounded-md bg-muted px-2 py-1 font-mono text-xs">
                {t("manualPathDialog.macExample")}
              </p>
            </section>
            <section className="space-y-1.5">
              <p className="font-medium">{t("manualPathDialog.windowsTitle")}</p>
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
                <li>{t("manualPathDialog.windows.step1")}</li>
                <li>{t("manualPathDialog.windows.step2")}</li>
                <li>{t("manualPathDialog.windows.step3")}</li>
                <li>{t("manualPathDialog.windows.step4")}</li>
              </ol>
              <p className="rounded-md bg-muted px-2 py-1 font-mono text-xs">
                {t("manualPathDialog.windowsExample")}
              </p>
            </section>
            <section className="space-y-1.5">
              <p className="font-medium">{t("manualPathDialog.terminalTitle")}</p>
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
                <li>{t("manualPathDialog.terminal.step1")}</li>
                <li>{t("manualPathDialog.terminal.step2")}</li>
                <li>{t("manualPathDialog.terminal.step3")}</li>
              </ol>
            </section>
          </div>
          <DialogFooter>
