        ...
        <>
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-1 sm:gap-2">
            <MetricCard
              ...
              to="/agents"
              description={
                <span>{t("dashboard.agentMetricDescription", {
            ...
            <MetricCard
              ...
              to="/issues"
              description={
                <span>{t("dashboard.taskMetricDescription", {
